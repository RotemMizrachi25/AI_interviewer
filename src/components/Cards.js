...
// //                                 </Typography>
// //                                 <Typography variant="body2" color="text.secondary">
// //                                     Nelly is empathetic behavioral interviewer who focuses on understanding a candidate’s past experiences and actions to assess how they align with the role’s requirements.
// //                                 </Typography>
// //                             </CardContent>
// //                             <CardActions>
...
//                             </CardContent>
//                             <CardActions>
//                                 <Button size="small" onClick={() => func({ interviewerId: 0 , selectedField,role})}>{t("start_simulation_card")}</Button>
//                             </CardActions>
//                         </CardActionArea>
//                     </Card>
//                 </Grid>
...
//                             </CardContent>
//                             <CardActions>
//                                 <Button size="small" onClick={() => func({ interviewerId: 1,selectedField,role })}>{t("start_simulation_card")}</Button>
//                             </CardActions>
//                         </CardActionArea>
//                     </Card>
//                 </Grid>
...
//                             </CardContent>
//                             <CardActions>
//                                 <Button size="small" onClick={() => func({ interviewerId: 2,selectedField,role })}>{t("start_simulation_card")}</Button>
//                             </CardActions>
//                         </CardActionArea>
//                     </Card>
//                 </Grid>
...
//                             </CardContent>
//                             <CardActions>
//                                 <Button size="small" onClick={() => func({ interviewerId: 3 ,selectedField,role})}>{t("start_simulation_card")}</Button>
//                             </CardActions>
//                         </CardActionArea>
//                     </Card>
//                 </Grid>
